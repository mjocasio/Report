...
def main():
    ...
    # Table details
    hana_table = "ehrp.ps_gvt_employment"
    virtual_table = "v_ehrp.v_ps_gvt_employment"
    ...
    hana_where_clause = f"""
        ...
        b.effseq = a.effseq  
    """
    fileSAP = NameGenerator("C:\python\ReportValidationHana",hana_table);
    ...
    try:
      ...
      #  OracleFile = NameGenerator("C:\python\ReportValidationHana",hana_table )
